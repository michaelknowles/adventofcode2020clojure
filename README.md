...
* [`src/cljs/adventofcode2020clojure/`](src/cljs/adventofcode2020clojure/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/adventofcode2020clojure/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `adventofcode2020clojure` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/adventofcode2020clojure/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns adventofcode2020clojure.example
  (:require [adventofcode2020clojure.config :as config])
